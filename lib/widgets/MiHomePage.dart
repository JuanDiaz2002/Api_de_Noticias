...
import 'package:apidenoticias/widgets/post.dart';
...
class _MyHomePageState extends State<MyHomePage>{
  ...
  static Future<List<Post>> getPosts() async {
    var url = Uri.parse("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=256efbd2b0e244ad91cb87747910c2c4");
    final response =
